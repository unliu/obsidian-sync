...
如果看起来它犯了错，不要着急指责它犯了错误，更不要直接上手帮它修复。充满尊重地询问它这么做的原因，理解这个原因，并提出补充信息让他再次判断。得到新的判断后，复盘记录规范文档。这是不是很像跟人的合作？好的团队管理不是管控对方，而是做好团队每个人的上下文管理。一些优秀的团队沟通习惯，放在 vibe coding 中一样适用、一样重要。所以纯粹的开发独狼做不好氛围编程——因为不擅长营造出好的「氛围」。
